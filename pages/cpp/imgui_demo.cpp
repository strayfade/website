...
void ImGui::ShowDemoWindow(bool* p_open, bool* mouseHovered)
{
    ...
    *mouseHovered = MousePos.x > CurrentWindowPos.x && MousePos.x < CurrentWindowPos.x + CurrentWindowSize.x && MousePos.y > CurrentWindowPos.y && MousePos.y < CurrentWindowPos.y + CurrentWindowSize.y;
...
void ImGui::ShowDemoWindow(bool*, bool* mouseHovered) {}
void ImGui::ShowUserGuide() {}
