...
const GenerateHeader = function (
    ...
    console.log(Article)
    return `
        <div class="Header" style="filter: ` + (Article.title != "" && !Article.background ? `invert(1) ` : `none`) + `">
        ...
        <div class="Sidebar SidebarRight" id="SidebarMain" style="filter: ` + (Article.title != "" && !Article.background ? `invert(1) ` : `none`) + `">
