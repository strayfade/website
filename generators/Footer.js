...
async function GenerateFooter(Article, Locale) {
    ...
    Output = `
        <footer>
        <div class="Footer">
        <div class="FooterInner DisplayWidth">

        <div class="FooterObject MobileHidden">
        <a aria-label="` + Localize(Locale, "source_code") + `" class="LinkNormal Underline HoverAccentColor" href="https://github.com/Strayfade/Website">` + Localize(Locale, "source_code") + `</a>
        </div>

        <div class="FooterObject FloatRight">
        <h1>` + Localize(Locale, "copyright_main").replace("2022", new Date(Date.now()).getFullYear()) + `</h1>
        </div>
