...
function CreateTooltip() {
    let Output = "";
    Output += "<div id='TooltipContainer' class='TooltipContainer MobileHidden'>"
...
function GenerateBody(Article, Locale, AvailablePages, AvailablePageSelector, Custom) {
    ...
    switch (AvailablePageSelector) {
        case AvailablePages.Home:
            ...
            Output += "<p><span>Hello! I am Noah, a </span><span data-tooltip='Automatically Updates'>" + CalculateAge() + "-year-old </span><span>software developer (primarily web development) and musician from the United States.</span></p>"
